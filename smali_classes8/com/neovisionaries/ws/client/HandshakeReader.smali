.class public Lcom/neovisionaries/ws/client/HandshakeReader;
...
# virtual methods
.method public final getContentLength(Ljava/util/Map;)I
    .locals 1
...
.method public final parseHttpHeader(Ljava/util/Map;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final readBody(Ljava/util/Map;Lcom/neovisionaries/ws/client/WebSocketInputStream;)[B
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 245
    invoke-virtual {p0, p1}, Lcom/neovisionaries/ws/client/HandshakeReader;->getContentLength(Ljava/util/Map;)I
...
.method public readHandshake(Lcom/neovisionaries/ws/client/WebSocketInputStream;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 48
    invoke-virtual {p0, p1}, Lcom/neovisionaries/ws/client/HandshakeReader;->readStatusLine(Lcom/neovisionaries/ws/client/WebSocketInputStream;)Lcom/neovisionaries/ws/client/StatusLine;

    move-result-object v0

    .line 51
    invoke-virtual {p0, p1}, Lcom/neovisionaries/ws/client/HandshakeReader;->readHttpHeaders(Lcom/neovisionaries/ws/client/WebSocketInputStream;)Ljava/util/Map;

    move-result-object v1

    .line 54
    invoke-virtual {p0, v0, v1, p1}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateStatusLine(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;Lcom/neovisionaries/ws/client/WebSocketInputStream;)V

    .line 57
    invoke-virtual {p0, v0, v1}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateUpgrade(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V

    .line 60
    invoke-virtual {p0, v0, v1}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateConnection(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V

    .line 63
    invoke-virtual {p0, v0, v1, p2}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateAccept(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;Ljava/lang/String;)V

    .line 66
    invoke-virtual {p0, v0, v1}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateExtensions(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V

    .line 69
    invoke-virtual {p0, v0, v1}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateProtocol(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V

    return-object v1
.end method

.method public final readHttpHeaders(Lcom/neovisionaries/ws/client/WebSocketInputStream;)Ljava/util/Map;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, v1}, Lcom/neovisionaries/ws/client/HandshakeReader;->parseHttpHeader(Ljava/util/Map;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/neovisionaries/ws/client/HandshakeReader;->parseHttpHeader(Ljava/util/Map;Ljava/lang/String;)V
...
.method public final readStatusLine(Lcom/neovisionaries/ws/client/WebSocketInputStream;)Lcom/neovisionaries/ws/client/StatusLine;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/neovisionaries/ws/client/WebSocketException;
...
.method public final validateAccept(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final validateConnection(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final validateExtensionCombination(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final validateExtensions(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 522
    :cond_4
    invoke-virtual {p0, p1, p2, v1}, Lcom/neovisionaries/ws/client/HandshakeReader;->validateExtensionCombination(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;Ljava/util/List;)V
...
.method public final validateProtocol(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final validateStatusLine(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;Lcom/neovisionaries/ws/client/WebSocketInputStream;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 229
    :cond_0
    invoke-virtual {p0, p2, p3}, Lcom/neovisionaries/ws/client/HandshakeReader;->readBody(Ljava/util/Map;Lcom/neovisionaries/ws/client/WebSocketInputStream;)[B
...
.method public final validateUpgrade(Lcom/neovisionaries/ws/client/StatusLine;Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
