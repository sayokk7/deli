.class public Lcom/neovisionaries/ws/client/WritingThread;
...
.method public constructor <init>(Lcom/neovisionaries/ws/client/WebSocket;)V
    ...
    .line 43
    sget-object v0, Lcom/neovisionaries/ws/client/ThreadType;->WRITING_THREAD:Lcom/neovisionaries/ws/client/ThreadType;
...
.method public static isHighPriorityFrame(Lcom/neovisionaries/ws/client/WebSocketFrame;)Z
    .locals 1
...
# virtual methods
.method public final addHighPriorityFrame(Lcom/neovisionaries/ws/client/WebSocketFrame;)V
    .locals 3
...
.method public final changeToClosing()V
    .locals 4
...
.method public final doFlush()V
    ...
    .line 422
    :try_start_0
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->flush()V
...
.method public final flushIfLongInterval(J)J
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/neovisionaries/ws/client/WebSocketException;
    ...
    .line 404
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->doFlush()V
...
.method public final flushIgnoreError()V
    .locals 0
...
.method public final isFlushNeeded(Z)Z
    .locals 0

    if-nez p1, :cond_1

    .line 391
    iget-object p1, p0, Lcom/neovisionaries/ws/client/WebSocketThread;->mWebSocket:Lcom/neovisionaries/ws/client/WebSocket;
...
.method public final main()V
    ...
    .line 89
    :goto_0
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->waitForFrames()I
    ...
    .line 97
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->flushIgnoreError()V
    ...
    .line 108
    :try_start_0
    invoke-virtual {p0, v0}, Lcom/neovisionaries/ws/client/WritingThread;->sendFrames(Z)V
    :try_end_0
    ...
    :goto_1
    :try_start_1
    invoke-virtual {p0, v1}, Lcom/neovisionaries/ws/client/WritingThread;->sendFrames(Z)V
    :try_end_1
...
.method public queueFrame(Lcom/neovisionaries/ws/client/WebSocketFrame;)Z
    ...
    .line 201
    invoke-virtual {p0, p1}, Lcom/neovisionaries/ws/client/WritingThread;->addHighPriorityFrame(Lcom/neovisionaries/ws/client/WebSocketFrame;)V
...
.method public runMain()V
    ...
    .line 55
    :try_start_0
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->main()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 78
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->notifyFinished()V
...
.method public final sendFrame(Lcom/neovisionaries/ws/client/WebSocketFrame;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/neovisionaries/ws/client/WebSocketException;
    ...
    .line 480
    invoke-virtual {p0}, Lcom/neovisionaries/ws/client/WritingThread;->changeToClosing()V
...
.method public final sendFrames(Z)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/neovisionaries/ws/client/WebSocketException;
    ...
    .line 382
    invoke-virtual {p0, p1}, Lcom/neovisionaries/ws/client/WritingThread;->isFlushNeeded(Z)Z
    ...
    .line 360
    invoke-virtual {p0, v2}, Lcom/neovisionaries/ws/client/WritingThread;->sendFrame(Lcom/neovisionaries/ws/client/WebSocketFrame;)V
    ...
    .line 379
    :cond_3
    invoke-virtual {p0, v0, v1}, Lcom/neovisionaries/ws/client/WritingThread;->flushIfLongInterval(J)J
...
.method public final waitForFrames()I
    .locals 4
