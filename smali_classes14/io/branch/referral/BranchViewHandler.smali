...
# static fields
.field public static thisInstance_:Lio/branch/referral/BranchViewHandler;


# instance fields
.field public branchViewDialog_:Landroid/app/Dialog;

.field public isBranchViewAccepted_:Z

.field public isBranchViewDialogShowing_:Z

.field public loadingHtmlInBackGround_:Z

.field public openOrInstallPendingBranchView_:Lio/branch/referral/BranchViewHandler$BranchView;

.field public parentActivityClassName_:Ljava/lang/String;

.field public webViewLoadError_:Z
...
.method public static synthetic access$1000(Lio/branch/referral/BranchViewHandler;)Z
    .locals 0
...
.method public static synthetic access$1200(Lio/branch/referral/BranchViewHandler;Lio/branch/referral/BranchViewHandler$BranchView;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)V
    .locals 0

    .line 37
    invoke-virtual {p0, p1, p2, p3}, Lio/branch/referral/BranchViewHandler;->createAndShowBranchView(Lio/branch/referral/BranchViewHandler$BranchView;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)V

    return-void
.end method

.method public static synthetic access$1302(Lio/branch/referral/BranchViewHandler;Z)Z
    .locals 0
...
.method public static synthetic access$400(Lio/branch/referral/BranchViewHandler;Ljava/lang/String;)Z
    .locals 0

    .line 37
    invoke-virtual {p0, p1}, Lio/branch/referral/BranchViewHandler;->handleUserActionRedirect(Ljava/lang/String;)Z
...
.method public static synthetic access$500(Lio/branch/referral/BranchViewHandler;)Landroid/app/Dialog;
    .locals 0
...
.method public static synthetic access$502(Lio/branch/referral/BranchViewHandler;Landroid/app/Dialog;)Landroid/app/Dialog;
    .locals 0
...
.method public static synthetic access$602(Lio/branch/referral/BranchViewHandler;Z)Z
    .locals 0
...
.method public static synthetic access$700(Lio/branch/referral/BranchViewHandler;Lio/branch/referral/BranchViewHandler$BranchView;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;Landroid/webkit/WebView;)V
    .locals 0

    .line 37
    invoke-virtual {p0, p1, p2, p3}, Lio/branch/referral/BranchViewHandler;->openBranchViewDialog(Lio/branch/referral/BranchViewHandler$BranchView;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;Landroid/webkit/WebView;)V

    return-void
.end method

.method public static synthetic access$902(Lio/branch/referral/BranchViewHandler;Z)Z
    .locals 0
...
# virtual methods
.method public final createAndShowBranchView(Lio/branch/referral/BranchViewHandler$BranchView;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)V
    .locals 7
...
.method public final handleUserActionRedirect(Ljava/lang/String;)Z
    .locals 4
...
.method public final openBranchViewDialog(Lio/branch/referral/BranchViewHandler$BranchView;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;Landroid/webkit/WebView;)V
    .locals 5
    ...
    .line 194
    invoke-virtual {p0, v2}, Lio/branch/referral/BranchViewHandler;->showViewWithAlphaAnimation(Landroid/view/View;)V

    .line 195
    invoke-virtual {p0, p3}, Lio/branch/referral/BranchViewHandler;->showViewWithAlphaAnimation(Landroid/view/View;)V
...
.method public final showBranchView(Lio/branch/referral/BranchViewHandler$BranchView;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)Z
    .locals 3
...
.method public showBranchView(Lorg/json/JSONObject;Ljava/lang/String;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)Z
    ...
    .line 83
    invoke-virtual {p0, v0, p3, p4}, Lio/branch/referral/BranchViewHandler;->showBranchView(Lio/branch/referral/BranchViewHandler$BranchView;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)Z
...
.method public showPendingBranchView(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v0, p1, v1}, Lio/branch/referral/BranchViewHandler;->showBranchView(Lio/branch/referral/BranchViewHandler$BranchView;Landroid/content/Context;Lio/branch/referral/BranchViewHandler$IBranchViewEvents;)Z
...
.method public final showViewWithAlphaAnimation(Landroid/view/View;)V
    .locals 3
